...
<div class="page-inner">
    ...
    <div class="card">
        <form method="POST" action="{{route('admin.navigations.update',$navigation)}}" id="form">
            @csrf
            @method('PUT')
            <div class="card-header d-flex d-justify-content-between">
                <div class="card-title font-weight-bold">Edit Navigations</div>
                <div class="ml-auto">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group ">
                            ...
                            <select name="parent_id" id="parent_id" class="form-control @error('parent_id') is-invalid @enderror select2" data-placeholder="Please Select Navigation" required="">
                                ...
                                <option value="{{$item->id}}" @if ($item->id == $navigation->parent_id) selected @endif>{{$item->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group ">
                            <label>Name*</label>
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Navigation Name" value="{{$navigation->name}}" required="">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" name="url" id="url" class="form-control @error('url') is-invalid @enderror" placeholder="Enter Navigation Url " value="{{$navigation->url}}" required="">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="number" name="order" id="order" class="form-control @error('order') is-invalid @enderror" placeholder="Enter Navigation Order " value="{{$navigation->order}}" required="">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group ">
                            <label>Nav Icon*</label>
                            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" placeholder="Enter Navigation Icon " value="{{$navigation->icon}}" required="">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group ">
                            ...
                            <select name="permission_name" class="form-control @error('permission_name') is-invalid @enderror select2"  data-placeholder="Please Select Permissions to Navigation" required>
                                ...
                                <option value="{{$item->id}}" @if ($item->name == $navigation->permission_name) selected @endif>{{$item->name}}</option>
                                @endforeach
                            </select>
